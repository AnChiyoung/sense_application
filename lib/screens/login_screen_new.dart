...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final pageControl = PageController(initialPage: 1);
                                  ...
                                  child: InkWell(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          SvgPicture.asset(
                                              'lib/assets/images/svg/${(isAutoLogin ? 'circle-checked_filled.svg' : 'circle_checked.svg')}',
                                              width: 20,
                                              height: 20),
                                        ...
                                        child: Align(
                                          ...
                                          child: Container(
                                              decoration: const BoxDecoration(
                                                  border: Border(
                                                      bottom: BorderSide(
                                                          color: Color(0XFF555555), width: 0.5))),
