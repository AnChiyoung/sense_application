...
//               child: Column(
//                 children: [
//                   EventInfoPlanTitle(model: EventModel()),
...
//                   ),
//                   SizedBox(height: 16.0.h),
//                   EventInfoPlanMemo(model: EventModel()),
...
//   String? title;
//   EventModel model;
//   EventInfoPlanTitle({super.key, this.title, required this.model});
//
//   @override
...
//           autofocus: false,
//           readOnly: widget.model.eventHost!.id == PresentUserInfo.id ? false : true,
...
//           onTap: () {
//             if(model.eventHost!.id == PresentUserInfo.id) {
...
//         builder: (context, data, child) {
//
//           EventModel model = context.read<CreateEventImproveProvider>().selectEventModel;
//
//           int city = data.city;
//           if(city == -1) {
//             locationString = '-';
...
//   String? memo;
//   EventModel model;
//   EventInfoPlanMemo({super.key, this.memo, required this.model});
//
//   @override
