...
class CreateEventCategoryBottomSheetView extends StatefulWidget {
  const CreateEventCategoryBottomSheetView({super.key});

  @override
  State<CreateEventCategoryBottomSheetView> createState() => _CreateEventCategoryBottomSheetViewState();
}

class _CreateEventCategoryBottomSheetViewState extends State<CreateEventCategoryBottomSheetView> {
  @override
