...
class _TravelStep06State extends State<TravelStep06> {
  TextEditingController travelStep06Controller = TextEditingController();

  @override
  void initState() {
    /// when back step, save bundle data
    travelStep06Controller.text = context.read<TasteProvider>().travelStep05;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          ContentDescription(presentPage: 6, totalPage: 6, description: '선호하지 않는 여행에 대해\n자유롭게 적어주세요',),
          ...
          Container(
            ...
            child: TextFormField(
                controller: travelStep06Controller,
                autofocus: false,
                ...
                decoration: InputDecoration(
                    ...
                    hintText: 'ex) 더운 곳은 별로라서... 시원한 지역이었으면 합니다.',
                ...
                onChanged: (v) {
                  context.read<TasteProvider>().travelStep06Change(v);
                }
            ),
