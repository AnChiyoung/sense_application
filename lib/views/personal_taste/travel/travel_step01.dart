...
class _TravelStep01State extends State<TravelStep01> {
  TextEditingController travelPriceController = TextEditingController();

  @override
  void initState() {
    /// when back step, save bundle data
    travelPriceController.text = context.read<TasteProvider>().travelBeforePrice.toString();
    super.initState();
  }
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: TextFormField(
                            controller: travelPriceController,
                            ...
                            onChanged: (v) {
                              ...
                              if(v.isEmpty) {
                                context.read<TasteProvider>().travelBeforePriceChange(0);
                              } else {
                                context.read<TasteProvider>().travelBeforePriceChange(int.parse(v));
                              }
                            }
                        ),
