...
class _LodgingStep01State extends State<LodgingStep01> {
  ...
  void initState() {
    ...
    _priceController.text = context.read<PreferenceProvider>().lodgingPrice.toString();
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      readOnly: limitLodgingPrice ? true : false,
                      autofocus: true,
                      ...
                      style: TextStyle(
                        color: limitLodgingPrice ? StaticColor.grey50099 : Colors.black,
                        fontSize: 14.sp,
                      ),
                      cursorHeight: 15.h,
                      ...
                      onChanged: (v) {
                        context
                            ...
                            .changeLodgingPrice(v.isEmpty ? 0 : int.parse(v), notify: true);
                      },
          ...
          Consumer<PreferenceProvider>(
            builder: (context, data, child) {
              ...
              return GestureDetector(
                onTap: () {
                  data.changeLimitLodgingPrice(!limitLodgingPrice, notify: true);
                },
                child: Row(
                  children: [
                    limitLodgingPrice
