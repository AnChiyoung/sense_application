...
class _ParentCommentFieldState extends State<ParentCommentField> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FeedProvider>(builder: (context, data, child) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    currentModel.content == '삭제된 댓글입니다.'
                        ? Row(children: [
                            UserProfileImage(
                                profileImageUrl: currentModel.commentUser!.profileImageUrl),
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 8),
                                  Text(
                                      currentModel.commentUser!.username! == ''
                                          ? 'user-${currentModel.commentUser!.id}'
                                          : data.selectCommentModel.commentUser!.username!,
                                      style: TextStyle(
                                          fontSize: 14,
                                          ...
                                          ? showModalBottomSheet(
                                              ...
                                              builder: (context) {
                                                return Wrap(children: [
                                                  myCommentBottomSheet(context, currentModel)
                                                ]);
                                              })
                                          : showModalBottomSheet(
                                              context: context,
                                              ...
                                              builder: (context) {
                                                return Wrap(children: [
                                                  reportBottomSheet(context, currentModel.id!)
                                                ]);
                                              });
                                    },
                      ...
                      child: Row(
                        children: [
                          currentModel.content == '삭제된 댓글입니다.'
                              ? CommentLikeButton(
                                  active: false,
                                  postId: currentModel.postBottomInfo!.id!,
                                  state: currentModel.isLiked!,
                                  id: currentModel.id!)
                              : CommentLikeButton(
                                  active: true,
                                  postId: currentModel.postBottomInfo!.id!,
                                  ...
                                  id: currentModel.id!),
                          const SizedBox(width: 4),
                          Text(currentModel.likeCount.toString(),
                              style: TextStyle(
                                  fontSize: 13,
                                  color: currentModel.isLiked == true
                          ...
                          const SizedBox(width: 4),
                          Text(currentModel.childCommentList!.length.toString(),
                              style: TextStyle(
                                  fontSize: 13,
                                  color: currentModel.isCommented == true
                                      ? StaticColor.mainSoft
                                      : StaticColor.grey400BB,
                                  fontWeight: FontWeight.w400)),
                        ],
                ...
                : Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return recommentField(currentModel.childCommentList!.elementAt(index),
                              currentModel.content == '삭제된 댓글입니다.' ? false : true, widget.postId!);
                        }),
                  ),
          ],
        );
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                      model.childCommentUser!.username! == ''
                          ? 'user-${model.childCommentUser!.id}'
                          : model.childCommentUser!.username!,
                      style: TextStyle(
                          fontSize: 14, color: StaticColor.grey70055, fontWeight: FontWeight.w500)),
                  const SizedBox(width: 4),
                  Image.asset('assets/feed/comment_dot.png', width: 3, height: 3),
                  const SizedBox(width: 4),
                  Text(commentCreatedTimeString,
                      style: TextStyle(
                          fontSize: 14, color: StaticColor.grey400BB, fontWeight: FontWeight.w500)),
                ],
              ),
              Material(
                  color: Colors.transparent,
                          ...
                          ? {
                              model.childCommentUser!.id == PresentUserInfo.id
                                  ? showModalBottomSheet(
                                      ...
                                      builder: (context) {
                                        return Wrap(
                                            children: [myRecommentBottomSheet(context, model)]);
                                      })
                                  : showModalBottomSheet(
                                      context: context,
                                      backgroundColor: Colors.transparent,
                                      builder: (context) {
                                        return Wrap(
                                            children: [recommentReportBottomSheet(context, model)]);
                                      })
                            }
                          : {};
                    },
              ...
              children: [
                ...
                Text(model.likeCount.toString(),
                    style: TextStyle(
                        fontSize: 13,
                        color:
                            model.isLiked! == true ? StaticColor.mainSoft : StaticColor.grey400BB,
                        fontWeight: FontWeight.w400)),
                const SizedBox(width: 16),
              ],
            ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      showDialog(
                          ...
                          builder: (context) {
                            return CommentDeleteDialog(
                                postId: model.postBottomInfo!.id, index: model.childCommentId!);
                            // return Container(
                            //   color: Colors.transparent,
                            //   child: Container(
                            //     width: 100,
