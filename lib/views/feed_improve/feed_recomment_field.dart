...
class ParentCommentField extends StatefulWidget {
  const ParentCommentField({Key? key}) : super(key: key);
      ...
      builder: (context, data, child) {
        ...
        return Column(
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    data.selectCommentModel.content == '삭제된 댓글입니다.'
                    ? Row(
                      children: [
                        UserProfileImage(profileImageUrl: data.selectCommentModel.commentUser!.profileImageUrl),
                      ...
                      children: [
                        Row(
                          children: [
                            UserProfileImage(profileImageUrl: data.selectCommentModel!.commentUser!.profileImageUrl),
                            const SizedBox(width: 8),
                            Text(data.selectCommentModel!.commentUser!.username! == '' ? 'user-${data.selectCommentModel!.commentUser!.id}' : data.selectCommentModel!.commentUser!.username!, style: TextStyle(fontSize: 14, color: StaticColor.grey70055, fontWeight: FontWeight.w500)),
                        ...
                        Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                data.selectCommentModel!.commentUser!.id == PresentUserInfo.id
                                    ? showModalBottomSheet(context: context, backgroundColor: Colors.transparent, builder: (context) { return Wrap(children: [myCommentBottomSheet(context, data.selectCommentModel!)]);})
                                    : showModalBottomSheet(context: context, backgroundColor: Colors.transparent, builder: (context) { return Wrap(children: [reportBottomSheet(context, data.selectCommentModel!.id!)]);});
                              },
                    ...
                    : Padding(
                      ...
                      child: Text(data.selectCommentModel!.content!),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          data.selectCommentModel.content == '삭제된 댓글입니다.'
                          ? CommentLikeButton(active: false, postId: data.selectCommentModel.postBottomInfo!.id!, state: data.selectCommentModel.isLiked!, id: data.selectCommentModel.id!)
                          : CommentLikeButton(active: true, postId: data.selectCommentModel.postBottomInfo!.id!, state: data.selectCommentModel.isLiked!, id: data.selectCommentModel.id!),
                          const SizedBox(width: 4),
                          Text(data.selectCommentModel!.likeCount.toString(), style: TextStyle(fontSize: 13, color: data.selectCommentModel.isLiked == true ? StaticColor.mainSoft : StaticColor.grey400BB, fontWeight: FontWeight.w400)),
                          const SizedBox(width: 16),
                          CommentButton(state: data.selectCommentModel.isCommented),
                          const SizedBox(width: 4),
                          Text(data.selectCommentModel!.childCommentList!.length.toString(), style: TextStyle(fontSize: 13, color: data.selectCommentModel.isCommented == true ? StaticColor.mainSoft : StaticColor.grey400BB, fontWeight: FontWeight.w400)),
                        ],
                      ),
                    ),
                  ],
            ...
            /// 대댓글
            data.selectCommentModel!.childCommentList!.isEmpty
                ? const SizedBox.shrink()
                : Expanded(
                  child: ListView.builder(
                      shrinkWrap: true,
                      itemCount: data.selectCommentModel!.childCommentList!.length,
                      itemBuilder: (context, index) {
                        return RecommentField(childCommentModel: data.selectCommentModel!.childCommentList!.elementAt(index), active: data.selectCommentModel.content == '삭제된 댓글입니다.' ? false : true);
                      }
                    ),
                ),
          ],
