                            ...
                            Expanded(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(backgroundColor: reasonState.contains(true) == true ? StaticColor.mainSoft : StaticColor.grey400BB, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(0.0)), elevation: 0.0),
                                    child: Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
