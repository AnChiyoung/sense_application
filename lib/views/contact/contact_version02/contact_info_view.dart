...
class _ContactInfoHeaderState extends State<ContactInfoHeader> {
  TextStyle titleStyle =
      TextStyle(fontSize: 16, color: StaticColor.black90015, fontWeight: FontWeight.w500);
        ...
        child: SizedBox(
          ...
          child: GestureDetector(
            ...
            child: UserProfileImage(
                profileImageUrl: widget.contactModel.profileImage, selectImage: data.selectImage),
          ),
        ),
      );
    });
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('기본정보',
              style: TextStyle(
                  fontSize: 16, color: StaticColor.grey70055, fontWeight: FontWeight.w700)),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: '이름을 입력해주세요',
              hintStyle: TextStyle(
                  fontSize: 16, color: StaticColor.loginHintTextColor, fontWeight: FontWeight.w400),
...
class _ContactInfoGenderState extends State<ContactInfoGender> {
  ...
  TextStyle nonSelectStyle =
      TextStyle(fontSize: 14, color: StaticColor.grey70055, fontWeight: FontWeight.w500);
  TextStyle selectStyle =
      const TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w700);
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: genderState == true ? selectColor : nonSelectColor),
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: genderState == true ? nonSelectColor : selectColor),
...
class _ContactInfoCategoryState extends State<ContactInfoCategory> {
  ...
  void initState() {
    context
        ...
        .categoryStateSet(widget.contactModel.contactCategoryObject!.id!);

    /// 최초 값은 수정 안된 값으로 저장
    context
        .read<ContactProvider>()
        .updateCategoryData(widget.contactModel.contactCategoryObject!.id!);
    super.initState();
  }
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: selectCategory == 1 ? selectColor : nonSelectColor),
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: selectCategory == 2 ? selectColor : nonSelectColor),
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: selectCategory == 3 ? selectColor : nonSelectColor),
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          elevation: 0.0,
                          backgroundColor: selectCategory == 4 ? selectColor : nonSelectColor),
...
class ContactInfoSaveButton extends StatefulWidget {
  ...
  double topPadding;
  double height;
  ContactInfoSaveButton(
      {super.key, required this.contactModel, required this.topPadding, required this.height});
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          height: 76,
          color: StaticColor.bottomButtonColor,
          child: const Padding(
    ...
    required this.positive,
          ...
          content: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: positive == true ? StaticColor.snackbarColor : StaticColor.errorColor,
                  width: 1),
            ),
            child: Container(
              color: Colors.transparent,
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: 16,
                          color:
                              positive == true ? StaticColor.snackbarColor : StaticColor.errorColor,
